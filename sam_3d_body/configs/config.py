...
_C.MODEL.HEIGHT_CONDITION = False  # if True, append GT neutral-pose body height (m) to NF context
...
_C.DATASET.VAL_DS = 'orbit-archviz-15-bbox44-smplx'
